...
public final class Utils {
    ...
    public static List<Book> fetchBookList(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of the books
        ...
        try {
            ...
            for (int i = 0; i < itemsArray.length(); i++) {
               ...
               String ID= currentBook.getString("id");
                ...
                // Create a new {@link Book} object with the Price, title, subtitle, author,publisher
                // and url from the JSON response.
                Book book = new Book(ID,title,subtitle, authors, publisher,url);
